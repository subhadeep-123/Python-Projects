...
class ChatClient(Frame):
    ...
    def initUI(self):
        ...
        self.root.geometry("%sx%s+%s+%s" % (self.FrameSizeX,
                                            self.FrameSizeY, int(FramePosX), int(FramePosY)))
        ...
        bottomLabel = Label(
            parentFrame, text="Created by Siddhartha under Prof. A. Prakash [Computer Networks, Dept. of CSE, BIT Mesra]")
